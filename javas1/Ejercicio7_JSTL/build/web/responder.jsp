    ...
    <body>
        <div class="container">
            <div class="row mt-5">
                <div class="col-3"></div>
                <div class="col-6">
                    <h2>Introduzca la respuesta</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-3"></div>
                <div class="col-1">
                    <img class="rounded-circle" style="width: 70%" src="${pregunta.usuario.urlFoto}">
                </div>
                <div>
                    <div>${pregunta.fecha}</div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <form action="preguntas">
                        ...
                        <input type="submit" class="btn btn-primary" value="Responder" name="accion">
