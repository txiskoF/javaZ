        ...
        <div class="container mt-5">
            ...
            <form action="Libros">
                <div class="form-group">
                    ...
                    <select class="custom-select" name="nombre">
                        <c:forEach items="${empleados}" var="e">
                            <option value="${e.nombre}:${e.apellidos}" ${param.nombre != null && param.nombre.equals(e.nombre.concat(":").concat(e.apellidos)) ?"SELECTED":""}>${e.nombreCompleto}</option>
                        </c:forEach>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="id" value="PMA42628M">
                </div>
