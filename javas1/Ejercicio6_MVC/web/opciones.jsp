        ...
        <div class="container">
            <div class="row mt-5">
                ...
                <div class="col-6">
                    ...
                    <ul class="mt-3">
                        <li><a href="reparaciones?accion=solicitar">Solicitar Reparaciones</a></li>
                        <li><a href="reparaciones?accion=comprobar">Comprobar Reparaciones</a></li>
                            <%
                                if (usuario.getRol().toLowerCase().equals("reparador/a")) {
                            %>
                        <li><a href="reparaciones?accion=reparar">Reparar</a></li>
                            <%
                                }
                            %>
                        <li><a href="reparaciones?accion=Salir">Salir</a></li>
                    </ul>
                </div>
            </div>
