package net.zabalburu.productosrest.modelo.controlador;
...
import net.zabalburu.productosrest.modelo.servicio.ProductoServicio;
...
public class ProductosController {
	...
	public ModelAndView index() {
		...
		System.out.println(servicio.getProducto(100));
		return mv;
	}
