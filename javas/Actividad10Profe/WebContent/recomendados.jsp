		...
		<c:if test="${empty libros }">
			<div class="row">
				<div class="col-12 text-center">
					<div class="alert alert-info">No hay recomendaciones</div>
					<a href="Recomendaciones?accion=Volver" class="btn btn-primary" name="accion" value="Volver">Volver</a>
				</div>
			</div>
		</c:if>
		<c:if test="${!empty libros }">
		...
		<form action="Recomendaciones">
			<div class="row m-5">			
				<div class="col-12">
					...
					<button class="btn btn-primary" name="accion" value="VerTodos">Ver Todos</button>
